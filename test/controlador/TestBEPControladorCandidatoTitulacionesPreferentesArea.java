...
import es.ujaen.uvirtual.modulo.bolsaempleo.controlador.candidato.ControladorCandidatoTitulacionesPreferentesArea;
...
public class TestBEPControladorCandidatoTitulacionesPreferentesArea {
	...
	private VistaCandidatoTitulacionesArea getVistaConAreas() throws ServletException, IOException {
		...
		peticion.setParameter(ControladorCandidatoTitulacionesPreferentesArea.PARAM_ACCION,
				ControladorCandidatoTitulacionesPreferentesArea.ACCION_DATATABLE_BOLSAS);
	 ...
	 */
	@Test
	public void testA05SeleccionarBolsa() throws ServletException, IOException {
		VistaCandidatoTitulacionesArea bean = getVistaConAreas();
