...
import es.ujaen.uvirtual.modulo.bolsaempleo.controlador.configuracion.ControladorGestionTitulacionesPreferentesArea;
...
public class TestBEPControladorGestionTitulacionesPreferentesArea {
	...
	// método para obtener la vista con la respuesta de incluir o eliminar una
	...
	public void testE05RepetirIncluirTitulacionesArea() throws ServletException, IOException {
		...
		getVistaCambiarTitulacionesPreferentes(ControladorGestionTitulacionesPreferentesArea.ACCION_INCLUIR_TITULACION_AREA, true,
				"[" + bean.getDatatableTitulaciones().getData().get(0).getCodNum().toString() + "]");
		VistaTitulacionesArea bean3 = getVistaCambiarTitulacionesPreferentes(ControladorGestionTitulacionesPreferentesArea.ACCION_INCLUIR_TITULACION_AREA, true,
				"[" + bean.getDatatableTitulaciones().getData().get(0).getCodNum().toString() + "]");
