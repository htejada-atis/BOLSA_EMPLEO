...
public class TestBEPControladorMisMeritos {
	 ...
	 */
	@Test
	public void testA02ObtenerMeritos() throws ServletException, IOException {
	 ...
	 */
	@Test
	public void testA03AgregarMerito() throws ServletException, IOException {
	 ...
	 */
	@Test
	public void testA04BorrarMeritos() throws ServletException, IOException {
		VistaMeritos bean = obtenerMeritos();
	 ...
	 */
	@Test
	public void testE01EliminarMeritosNoValidos() throws ServletException, IOException {
		PeticionHttp peticion = UtilsTestBolsaEmpleo.peticionAutenticadaCandidato();
		peticion.setParameter(ControladorMisMeritos.PARAM_ACCION, ControladorMisMeritos.ACCION_ELIMINAR_MERITOS);
	 ...
	 */
	@Test
	public void testE02AgregarMeritoApartadoSeleccionadoNoValido() throws ServletException, IOException {
	...
	public void testE03ErrorUsuarioRol() throws IOException, ServletException {
		...
		assertEquals(MENSAJE_CON_ERROR, 1, bean.getMensajesDeError().size());
		assertEquals(MENSAJE_SIN_EXITO, 0, bean.getMensajesDeExito().size());
		assertEquals(ControladorMisMeritos.MENSAJE_ERROR_SIN_PERMISO_CANDIDATO, bean.getMensajesDeError().get(0).toString());
	}
	 ...
	 */
	@Test
	public void testE05ObtenerMeritos() throws ServletException, IOException {
		PeticionHttp peticion = UtilsTestBolsaEmpleo.peticionAutenticadaCandidato();
		peticion.setParameter(ControladorMisMeritos.PARAM_ACCION, ControladorMisMeritos.ACCION_DATATABLE);
