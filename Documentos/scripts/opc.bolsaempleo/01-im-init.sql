...
INSERT INTO adm_parametros (config_codalf, param_codalf, desid, valor) VALUES ( DEFAULT, 'bolsaempleo.maxEspacioArchivo', 'Máximo tamaño de archivo para subida expresado en bytes', '5000000'); 
INSERT INTO adm_parametros (config_codalf, param_codalf, desid, valor) VALUES ( DEFAULT, 'bolsaempleo.codMeritoPreferente', 'Código de bloque del mérito preferente', 'IV');
...
INSERT INTO ADM_ROL (rol_codnum, descripcion, valor) VALUES(1053, 'Director departamento', 'bolempdirdepartamento');