...
function DataTable(id, config) {
	...
	this.filterParams = this.stateSave && sessionStorage.getItem(this.idFinal) != null 
		? !this.params.filter || this.params.filter.length === 0 ? {} : json2Object(this.params.filter) : {};
