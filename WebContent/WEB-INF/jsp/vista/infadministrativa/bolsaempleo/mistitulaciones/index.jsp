...
<div class="bolsa-empleo misdatos-form">
	...
	<div class="titulo-bolsa-empleo" style="float:right; margin-top:1.2rem">
		<a class="link-btn" id="nueva_titulacion" href="<%= request.getRequestURI() %>" style="margin-top:0">Nueva titulaci�n</a>
	</div>
	...
	<table class="bluetable bolsaempleo" id="tableTitulacionesUsuario">
		<tr>
			...
			<th scope="col" style="width:60%">Titulaci�n</th>		
			<th scope="col" style="width:40%">Descripci�n</th>	
...
$(document).ready(function() {	
	...
	function enviaAccion(accion, selected) {
		if (selected.length == 0) {
			Atis.alertDialog('Estado de las titulaciones', 'Seleccione al menos una titulaci�n.');
			return;
		}
		Atis.confirmDialog("Borrar titulaci�n", "�Desea eliminar las titulaci�nes seleccionadas, relacionadas con su usuario?", {
        	Si: function() {
        		var params = {
        				'a': accion, 
