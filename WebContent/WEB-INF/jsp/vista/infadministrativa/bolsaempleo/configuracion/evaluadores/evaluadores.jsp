...
<div class="bolsa-empleo evaluadores-listar">
	...
	<table class="bluetable bolsaempleo" id="tableAreas" style="<%= departamento == null ? "visibility: hidden" : "" %>">
		<tr>
	...
	<table class="bluetable bolsaempleo" id="tableEvaluadoresArea" style="<%= area == null ? "visibility: hidden" : "" %>">
		<tr>
