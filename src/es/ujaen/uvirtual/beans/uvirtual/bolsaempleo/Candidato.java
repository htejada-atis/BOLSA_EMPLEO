...
public class Candidato extends UsuarioBolsaEmpleo implements Serializable {
	 ...
	 * @param pactivo .
	 */
	public Candidato(Integer pcodNumArea, boolean pactivo) {
		super();
	 ...
	 * @param pactivo .
	 */
	public Candidato(UsuarioBolsaEmpleo pusuario, Integer pcodNumArea, boolean pactivo) {
		super(pusuario);
		this.codNumArea = pcodNumArea;
		this.activo = pactivo;
	}
	 ...
	 * @param pusuario .
	 */
	public Candidato(UsuarioBolsaEmpleo pusuario) {
		super(pusuario);
	}
