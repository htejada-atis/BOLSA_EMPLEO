...
public class ModeloOfertaCandidato {
	 ...
	 * @throws UVException .
	 */
	public BolsaEmpleoDataTable<OfertaCandidato> listadoPlazasOfertadasCandidato(Map<String, String[]> params, UsuarioBolsaEmpleo usuario)
		...
		String consulta = ""
				...
				+ " WHERE   bepplo.CURSO = bepcon.CURSO "
