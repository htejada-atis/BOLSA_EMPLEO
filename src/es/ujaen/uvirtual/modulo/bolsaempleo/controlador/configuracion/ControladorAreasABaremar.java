...
public class ControladorAreasABaremar extends HttpServlet {
	...
	private boolean init(VistaAreasBaremar bean, UVDatos datos, HttpServletRequest request, HttpServletResponse response) throws SQLException, UVException, IOException {
