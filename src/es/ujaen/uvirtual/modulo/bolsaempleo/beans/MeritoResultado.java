 ...
 */
public class MeritoResultado implements Serializable {
	 ...
	 * @param pexcluido .
	 */
	public MeritoResultado(Merito pmerito, MeritoSolicitud pmeritoSolicitud, List<MeritoSolicitudValoracion> pvaloraciones, Boolean pexcluido) {
		this.merito = pmerito;
