...
public class VistaMisResultados extends Vista implements Serializable {
	...
	private String urlAlegaciones;
	private SolMerBolAlegacion solMerBolAlegacion;
	private ItemBaremacion itemBaremacion;	
	private boolean mostrarBotonAlegaciones;
	...
	public boolean isMostrarBotonVerAlegacion() {
		return this.alegacion != null;
	}

	public boolean isMostrarBotonCrearAlegacion() {
		return this.alegacion == null
			&& this.bolsa != null
			&& ModeloBolsa.BOLSA_ESTADO_ALEGACIONES.equals(this.bolsa.getEstado());
	}

	public String getUrlAlegaciones() {
		return this.urlAlegaciones;
	}

	public void setUrlAlegaciones(String url) {
		this.urlAlegaciones = url;
	}

	public SolMerBolAlegacion getSolMerBolAlegacion() {
		return solMerBolAlegacion;
	}

	public void setSolMerBolAlegacion(SolMerBolAlegacion solMerBolAlegacion) {
		this.solMerBolAlegacion = solMerBolAlegacion;
	}

	public ItemBaremacion getItemBaremacion() {
		return itemBaremacion;
	}

	public void setItemBaremacion(ItemBaremacion itemBaremacion) {
		this.itemBaremacion = itemBaremacion;
	}	
}
