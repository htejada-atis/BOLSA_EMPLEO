...
public class ModeloValidar {
	 ...
	 * @throws UVException  .
	 */
	public BolsaEmpleoDataTable<Bolsa> listadoAreasSujetasAfinidad(Solicitud solicitud, Map<String, String[]> params) throws SQLException, UVException {
		return this.listadoAreas(solicitud, true, params);
	}
	 ...
	 * @throws UVException  .
	 */
	public BolsaEmpleoDataTable<Bolsa> listadoAreasNoSujetasAfinidad(Solicitud solicitud, Map<String, String[]> params) throws SQLException, UVException {
		return this.listadoAreas(solicitud, false, params);
	}

	private BolsaEmpleoDataTable<Bolsa> listadoAreas(Solicitud solicitud, Boolean sujetasAfinidad, Map<String, String[]> params) throws SQLException, UVException {
		...
		String consulta = "SELECT bepbol.* " + "FROM TBEP_BOLSAS bepbol "
				...
				+ "AND bepsbo.BEPSOL_CODNUM = ? " + "AND bepafi.FLGSUJETOAFINIDAD = '" + (sujetasAfinidad ? "S" : "N")
				+ "' ";
		...
		try (Connection conexion = ConexionUvirtual.obtenerInstancia();
			...
			int paramIndex = 1;
			stmt.setInt(paramIndex, solicitud.getCodNum());
			stmtCount.setInt(paramIndex++, solicitud.getCodNum());
